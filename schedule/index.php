		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="img-container">
					<input name="username" id="username" value="<?php echo $sess_username; ?>" hidden>
					<div class="row">
						<div class="col-sm-12">  
...
function display_events() {
    var username = '<?php echo $sess_username; ?>';
...
$.ajax({
    ...
    $.each(result, function (i, item) {
    	events.push({
            ...
            event_location: result[i].event_location,
...
$.ajax({
 ...
 type:"POST",
 dataType: 'json',
 data: {event_name:event_name,event_location:event_location,event_start_date:event_start_date,event_end_date:event_end_date,username:username},
 success:function(response){
