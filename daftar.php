...
if (isset($_SESSION['user'])) {
    ...
    if (isset($_POST['daftar'])) {
        ...
        if (mysqli_num_rows($check) > 0) {
            echo "<script>alert('Akun sudah terdaftar!','error')</sscript>";
        } else {
            ...
            if ($daftar == TRUE) {
                $check_akun = mysqli_query($koneksi, "SELECT * FROM akun WHERE username = '$username'");
                $data_akun = mysqli_fetch_assoc($check_akun);
                $_SESSION['user'] = $data_akun;
            header("Location: ".$url);
...
.btn {
  ...
  .btn.btn-primary {
	...
	<body class="img js-fullheight" style="background-image: url(bewith.jpeg);">
	...
	<section class="ftco-section">
		...
		<div class="container">			
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
	            	<button type="submit" class="form-control btn btn-primary submit px-3" name="daftar">Daftar</button>
	            </div>
	          </form>	        
				</div>
			</div>
